...
var start, isBlink, isLight, isRun, isShow, isWarned, handler, latency, stopBy, delay, audioRemind, audioEnd, dolphin, newAudio, soundToggle, show, adjust, toggle, reset, blink, count, run, resize, remainingTime, updateDolphin, resetDolphin;
start = null;
isBlink = false;
isLight = true;
isRun = false;
